...
impl CpuidPage {
    ...
    pub fn import_from_kvm(&mut self, kvm_fd: &mut Kvm) -> anyhow::Result<()> {
        ...
        for kvm_entry in kvm_cpuid_entries.as_slice() {
            ...
            let mut snp_cpuid_entry = CpuidFunctionEntry::default();

            snp_cpuid_entry.eax_in = kvm_entry.function;
            snp_cpuid_entry.ecx_in = {
            ...
            snp_cpuid_entry.xcr0_in = 0;
            snp_cpuid_entry.xss_in = 0;
            snp_cpuid_entry.eax = kvm_entry.eax;
            snp_cpuid_entry.ebx = kvm_entry.ebx;
            snp_cpuid_entry.ecx = kvm_entry.ecx;
            snp_cpuid_entry.edx = kvm_entry.edx;

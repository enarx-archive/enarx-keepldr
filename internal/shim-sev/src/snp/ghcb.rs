...
pub const GHCB_REGISTER_GPA_REQUEST: u64 = 0x12;
pub const GHCB_REGISTER_GPA_RESPONSE: u64 = 0x13;
...
fn ghcb_msr_make_page_shared(page_virt: VirtAddr) {
    ...
    pvalidate(page_virt, 0, 0).unwrap();
...
impl GhcbHandle {
    fn new(ghcb: &'static mut Ghcb) -> Self {
        ...
        unsafe {
            ...
            let ret = vmgexit_msr(GHCB_REGISTER_GPA_REQUEST, gpa, GHCB_REGISTER_GPA_RESPONSE);
